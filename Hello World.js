//Cycles through favicons to say hello world on the tab that the script was run on, reload the page to stop it
        ...
        return $jscomp.asyncExecutePromiseGeneratorProgram(function(c) {
            switch (c.nextAddress) {
                ...
                case 2:
                    ...
                    b = document.querySelector("link[rel*='icon']") || document.createElement("link");
                    b.type = "image/png";
                    b.href = "https://raw.githubusercontent.com/RandomScriptsThatArePoorlyMade/Favicons/main/favicon_H.ico";
                    return c.yield(wait(500), 5);
                case 5:
                    return b.href =
                        "https://raw.githubusercontent.com/RandomScriptsThatArePoorlyMade/Favicons/main/favicon_E.ico", c.yield(wait(500), 6);
                case 6:
                    return b.href = "https://raw.githubusercontent.com/RandomScriptsThatArePoorlyMade/Favicons/main/favicon_L.png", c.yield(wait(500), 7);
                case 7:
                    return b.href = "https://raw.githubusercontent.com/RandomScriptsThatArePoorlyMade/Favicons/main/favicon_L_2.png", c.yield(wait(500), 8);
                case 8:
                    return b.href = "https://raw.githubusercontent.com/RandomScriptsThatArePoorlyMade/Favicons/main/favicon_o_1.ico", c.yield(wait(500), 9);
                case 9:
                    return b.href = "https://raw.githubusercontent.com/RandomScriptsThatArePoorlyMade/Favicons/main/favicon_w.ico", c.yield(wait(500), 10);
                case 10:
                    return b.href =
                        "https://raw.githubusercontent.com/RandomScriptsThatArePoorlyMade/Favicons/main/favicon_o_2.ico", c.yield(wait(500), 11);
                case 11:
                    return b.href = "https://raw.githubusercontent.com/RandomScriptsThatArePoorlyMade/Favicons/main/favicon_R.ico", c.yield(wait(500), 12);
                case 12:
                    return b.href = "https://raw.githubusercontent.com/RandomScriptsThatArePoorlyMade/Favicons/main/favicon_L_2.png", c.yield(wait(500), 13);
                case 13:
                    return b.href = "https://raw.githubusercontent.com/RandomScriptsThatArePoorlyMade/Favicons/main/favicon_D.ico", c.yield(wait(500), 3);
                case 3:
                    a++, c.jumpTo(2)
            }
        })
