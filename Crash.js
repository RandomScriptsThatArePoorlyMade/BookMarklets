        ...
        return $jscomp.asyncExecutePromiseGeneratorProgram(function(b) {
            switch (b.nextAddress) {
                ...
                case 2:
                    ...
                    alert("10");
                    return b.yield(wait(100), 5);
                case 5:
                    return alert("9"), b.yield(wait(100), 6);
                case 6:
                    return alert("8"), b.yield(wait(100), 7);
                case 7:
                    return alert("7"), b.yield(wait(100), 8);
                case 8:
                    return alert("6"), b.yield(wait(100), 9);
                case 9:
                    return alert("5"), b.yield(wait(100), 10);
                case 10:
                    return alert("4"), b.yield(wait(100), 11);
                case 11:
                    return alert("3"), b.yield(wait(100), 12);
                case 12:
                    return alert("2"), b.yield(wait(100), 13);
                case 13:
                    return alert("1"), b.yield(wait(100), 3);
                case 3:
                    a--;
                    b.jumpTo(2);
                    break;
