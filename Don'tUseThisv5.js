...
$jscomp.polyfillIsolated = function(a, b, c, d) {
    ...
    null != b && (a ? $jscomp.defineProperty($jscomp.polyfills, e, {
        ...
        writable: !0,
        value: b
    }) : b !== c && (void 0 === $jscomp.propertyToPolyfillSymbol[e] && (c = 1E9 * Math.random() % 3 E % 3 E % 3E0, $jscomp.propertyToPolyfillSymbol[e] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(e) : $jscomp.POLYFILL_PREFIX + c +  $  + e), $jscomp.defineProperty(d, $jscomp.propertyToPolyfillSymbol[e], {
        configurable: !0,
        writable: !0,
        value: b
    })))
...
function  == typeof  Object.setPrototypeOf ? Object.setPrototypeOf : $jscomp.underscoreProtoCanBeSet() ? function(a, b) {
    a.__proto__ = b;
    if (a.__proto__ !== b) throw n ew  TypeError(a +   is n ot  extensible );
    return  a
} : null;
...
$jscomp.generator.ensureIteratorResultIsObject_ = function(a) {
    if (!(a  instanceof  Object)) throw n ew  TypeError(  Iterator  result   + a +   is n ot  an  object );
};
...
$jscomp.generator.Context.prototype.start_ = function() {
    if (this.isRunning_) throw n ew  TypeError(  Generator  is  already  running );
    this.isRunning_ = !0
};
...
$jscomp.generator.Context.prototype.leaveFinallyBlock = function(a, b) {
    ...
    if (c = this.abruptCompletion_ = this.abruptCompletion_ || c) {
        ...
        void 0 != c.jumpTo && this.finallyAddress_ % 3 Cc.jumpTo ? (this.nextAddress = c.jumpTo, this.abruptCompletion_ = null) : this.nextAddress = this.finallyAddress_
    } else  this.nextAddress = a
};
$jscomp.generator.Context.prototype.forIn = function(a) {
    return n ew  $jscomp.generator.Context.PropertyIterator(a)
};
...
$jscomp.generator.Engine_.prototype.throw_ = function(a) {
    this.context_.start_();
    if (this.context_.yieldAllIterator_) return  this.yieldAllStep_(this.context_.yieldAllIterator_[ 
        throw ], a, this.context_.next_);
...
$jscomp.asyncExecutePromiseGenerator = function(a) {
    ...
    return n ew  Promise(function(d, e) {
        function  f(g) {
