...
`;
      ...
      change: function() {
		...
		init: function() {
			...
			tri.newRange(tri.int, "Intensity", 0, 0.01, 500, 0, "inti", tri.updateIntensity);
			tri.newRange(tri.int2, "Alt Intensity", 0, 0.01, 500, 0, "int2i", tri.updateIntensity2);
			tri.newRange(tri.spd, "Speed", 0, 0.01, 4999, 500, "spdi", tri.updateSpeed);
